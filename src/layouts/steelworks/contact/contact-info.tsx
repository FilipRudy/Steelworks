...
import "../../../css/steelworks/contact/contact-info.css";
        ...
        <div>
            ...
            <div className="contact-info-container">
                ...
                <div className="contact-info-card">
                    ...
                    <p className={"work-sans"}>  {"Damian Wisłobocki: "}</p>
                    <p><a className={"work-sans"} href="tel:+48-533-533-551">{"+48 533 533 551"}</a></p>
                    <p className={"work-sans"}>{"Szymon Wisłobocki: "}</p>
                    <p><a className={"work-sans"} href="tel:+48-533-533-557">{"+48 533 533 557"}</a></p>
                    <h2 className={"clash-font"}>{t("contact-info.email")}</h2>
                    <p className={"work-sans"}>{t("contact-info.officeEmail")}</p>
                    <p><a className={"work-sans"} href="mailto:biuro@stalownia.katowice.pl"> {"biuro@stalownia.katowice.pl"}  </a></p>
                    <p className={"work-sans"}>{t("contact-info.accountingDepartmentEmail")} </p>
                    <p><a className={"work-sans"} href="mailto:ksiegowosc@stalownia.katowice.pl"> {"ksiegowosc@stalownia.katowice.pl"} </a></p>
