            ...
            <div className="footer-content">
                ...
                <div className="footer-text">
                    ...
                    <div className="company-info footer-text work-sans">
                        <h5>Stalownia Katowice</h5>
                        <h6>NIP 6343009179</h6>
                ...
                <div className="footer-text">
                    <div className="company-info footer-text work-sans">
                        ...
                        <h6><a href="tel:+48-533-533-551">{"+48 533 533 551"}</a></h6>
                        <h6><a href="tel:+48-533-533-557">{"+48 533 533 557"}</a></h6>
                    </div>
                </div>
                <div className="line-vertical"></div>
